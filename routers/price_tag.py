...
def create_price_tag(price_tag: price_tag_schema.PriceTagCreate,
    ...
    price_tag_crud.create(db, price_tag, user_id)
...
def delete_price_tag(price_tag_id: int, db: Session = Depends(get_db), user_id=Depends(get_user_id)):
    price_tag_crud.delete(db, price_tag_id, user_id)
...
def update_price_tag(
        ...
        db: Session = Depends(get_db),
        user_id=Depends(get_user_id)):
    price_tag_crud.update(db, price_tag_id, price_tag, user_id)
